...
export default function Sidebar() {
  ...
  return (
    <div id="sidebar" className="hidden lg:flex flex-col w-64 border-r border-gray-800 sticky top-0 h-screen" style={{backgroundColor: "#121212"}}>
      <div className="p-6 border-b border-gray-800">
        <h1 className="text-primary font-display text-2xl">Sophia</h1>
        <p className="text-light-dimmed text-sm mt-1">Your AI companion</p>
      </div>
